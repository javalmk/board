...
<body>
	...
	<div class="container">
		...
		<form method="post" class="form-group" action="update.do">
			<table align="center">
				<thead>
					<tr>
						<th><h1>게시글 수정</h1><hr /></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<input class="form-control" name="title" type="text" placeholder="제목을 입력하세요" value="${dto.title }"/>
						</th>
					</tr>
					<tr>
						<th>
							<label for="writer">작성자</label>
							<input class="form-control" name="writer" type="text" placeholder="작성자를 입력하세요" value="${dto.writer }"/>
						</th>
					</tr>
					<tr>
						<td>
